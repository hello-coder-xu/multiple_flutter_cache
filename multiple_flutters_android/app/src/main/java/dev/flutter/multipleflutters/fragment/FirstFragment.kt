...
class FirstFragment : Fragment(), DataModelObserver {
    ...
    override fun onCreateView(
        ...
        println("原生 第一个 onCreateView")
        val currentView = inflater.inflate(R.layout.first_fragment, container, false)
    ...
    private fun initView(view: View) {
        ...
        nextPage.setOnClickListener {
            ...
            flutterIntent.putExtra("initialRoute", "/first")
